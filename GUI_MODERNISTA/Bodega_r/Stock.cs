...
namespace Diseno
{
    public partial class Stock : MaterialForm
    {
        ...
        private void Stock_Load(object sender, EventArgs e)
        {
            ...
            CbxCategoria.DisplayMember = "familia"; //campo que queres mostrar
            CbxCategoria.ValueMember = "id_familia"; //valor que capturas
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (result == System.Windows.Forms.DialogResult.Yes)
                    {
                        ...
                        string destino = @"D:\Downloads\GUI-Modern-Parte-2-Formulario-Moderno-y-Plano-C-Sharp-y-WinForm-master\Imagenes_Stock\" + TxtNombre.Text + ".Jpeg";
        ...
        private void DtStock_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmd.CommandText = "select imagen from producto where id_producto = " + TxtID.Text;
            ...
            try
            {
                ...
                while (my_reader.Read())
                {
                    ...
                    else
                    {
                        ...
                        PicImagen.Image = System.Drawing.Image.FromStream(mstream);
                    }
                }
            }
            catch
        ...
        private void BtnCategoria_Click(object sender, EventArgs e)
        {
            ...
            LblNombre.Text = "Nombre Categoria:";
        }
